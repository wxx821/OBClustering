...
public:
    ...
    void insertTitle1(const QString& text);
    void insertTitle2(const QString& text);
    void insertTitle3(const QString& text);
    void insertTitle4(const QString& text);
    void insertPic(const QString& picfile);
    void insertPage();
