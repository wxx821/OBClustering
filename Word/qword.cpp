...
void QWord::insertTitle1(const QString& text){
    QAxObject* selection  = m_word->querySubObject("Selection");
    if(NULL== selection)
    {
        return;
    ...
    selection->dynamicCall("TypeText(const QString&)",text);
    selection->dynamicCall("SetStyle(QVariant)", QString::fromLocal8Bit("标题 1"));
}

void QWord::insertTitle2(const QString& text){
    QAxObject* selection  = m_word->querySubObject("Selection");
    if(NULL== selection)
    {
        return;
    ...
    selection->dynamicCall("TypeText(const QString&)",text);
    selection->dynamicCall("SetStyle(QVariant)", QString::fromLocal8Bit("标题 2"));
}

void QWord::insertTitle3(const QString& text){
    QAxObject* selection  = m_word->querySubObject("Selection");
    if(NULL== selection)
    {
        return;
    ...
    selection->dynamicCall("TypeText(const QString&)",text);
    selection->dynamicCall("SetStyle(QVariant)", QString::fromLocal8Bit("标题 3"));
}

void QWord::insertTitle4(const QString& text){
    QAxObject* selection  = m_word->querySubObject("Selection");
    if(NULL== selection)
    {
        return;
    ...
    selection->dynamicCall("TypeText(const QString&)",text);
    selection->dynamicCall("SetStyle(QVariant)", QString::fromLocal8Bit("标题 4"));
}

void QWord::insertPic(const QString& picfile){
    QAxObject* selection  = m_word->querySubObject("Selection");
    if(NULL== selection)
    {
        return;
    ...
    selection->querySubObject("InlineShapes")->dynamicCall("AddPicture(const QString&)",picfile);

//    QList<QVariant>qList;
//    QVariant tmp = range->asVariant();
//            qList<<QVariant(picfile);
...
{	
    ...
    //tables->querySubObject("Add(QVariant,int,int)",range->asVariant(),row,column);
    ...
    //table->dynamicCall( "Add(QAxObject*, Long ,Long )",params);
...
{	
    ...
    tables->querySubObject("Add(QAxObject*, int, int, QVariant&, QVariant&)", params);
    //tables->querySubObject("Add(QVariant,int,int)",range->asVariant(),row,column);
    //tables->dynamicCall( "Add(QAxObject*, Long ,Long )",params);
